  ...
  <ul>
    ...
    <li class="submenu"> <a href="<?= base_url('index.php/Revenue/service')?>"><i class="icon icon-briefcase"></i> <span>Service Delivery</span> <span class="label label-important">5</span></a>
      <ul>
        ...
        <li class="active"><a href="<?= base_url('index.php/Revenue/data_sd')?>"> Data Service Delivery</a></li>
      </ul>
    </li>    
...
<div id="content">
  <div id="content-header">
    ...
    <h1>Data Service Delivery</h1>
  </div>
  
  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <h4>Revenue Service Delivery Rp <b><?= $rev;?></b></h4>
      </div>
    </div>
  </div>
