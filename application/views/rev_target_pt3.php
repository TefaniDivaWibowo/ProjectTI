...
<div id="content-header">
  ...
  <h1>Form Update Target Revenue Prog Optimization PT3</h1>
</div>
  
    <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <h4>Target Revenue Prog Optimization PT3 IDR <b>
      <?php if($rev == NULL){
        echo "Belum terisi";
      }else{
        echo $rev;
...
<div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <form action="<?php echo base_url()."index.php/revtarget/tambah_target_pt3";?>" method="post">
