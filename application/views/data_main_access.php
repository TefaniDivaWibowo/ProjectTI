  ...
  <ul>
    ...
    <li class="submenu"> <a href=""><i class="icon icon-bandcamp"></i> <span>Infrastructure Service</span> <span class="label label-important">4</span></a>
      <ul>
        ...
        <li class="active"><a href="<?= base_url('index.php/Revenue/data_main_access')?>">Data Maintenance Access</a></li>
...
<div id="content">
  <div id="content-header">
    ...
    <h1>Data Maintenance Access</h1>
  </div>

  <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <h4>Revenue Maintenance Access Rp <b><?= $rev;?></b></h4>
      </div>
    </div>
  </div>
