...
<div id="content-header">
  ...
  <h1>Form Update Target Revenue Prog Optimization PT2</h1>
</div>
  
    <div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <h4>Target Revenue Prog Optimization PT2 IDR <b><?= $rev;?></b> M</h4>
      </div>
    </div>
  </div>
...
<div class="container-fluid">
    <div class="row-fluid">
      <div class="span12">
      <form action="<?php echo base_url()."index.php/revtarget/tambah_target_pt2";?>" method="post">
